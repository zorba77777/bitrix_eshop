...
<?endif?>
				<input type="password" name="USER_PASSWORD" maxlength="255" placeholder="<?=GetMessage('PLACEHOLDER') ?>" value="<?=$arResult["USER_PASSWORD"]?>" autocomplete="off" />
	<?=GetMessage('AUTH_PASS_CHECK')?>
			</div>
		</div>
...
<?endif?>
				<input type="password" name="USER_CONFIRM_PASSWORD" maxlength="255" placeholder="<?=GetMessage('PLACEHOLDER') ?>" value="<?=$arResult["USER_CONFIRM_PASSWORD"]?>" autocomplete="off" />
			</div>
		</div>
		...
		<div class="bx-authform-formgroup-container">
			...
			<div class="bx-authform-input-container">
				<input type="text" name="USER_EMAIL" maxlength="255" placeholder="name@site.domain" value="<?=$arResult["USER_EMAIL"]?>" />
			</div>
		</div>
