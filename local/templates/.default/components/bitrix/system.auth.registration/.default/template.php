            ...
            <form method="post" action="<?= $arResult["AUTH_URL"] ?>" name="bform" enctype="multipart/form-data">
                ...
                <div class="bx-authform-formgroup-container">
                    ...
                    <div class="bx-authform-input-container">
                        ...
                        <? endif ?>
                        <input type="text" name="USER_CONFIRM_PASSWORD" maxlength="255"
                               placeholder="<?= GetMessage("PLACEHOLDER_PASSWORD") ?>"
                ...
                <div class="bx-authform-formgroup-container">
                    ...
                    <div class="bx-authform-input-container">
                        <input type="text" name="USER_EMAIL" maxlength="255"
                               placeholder="<?= GetMessage("PLACEHOLDER_EMAIL") ?>"
                    ...
                    <? foreach ($arResult["USER_PROPERTIES"]["DATA"] as $FIELD_NAME => $arUserField): ?>
                        ...
                        <div class="bx-authform-formgroup-container">
                            <div class="bx-authform-label-container"><? if ($arUserField["MANDATORY"] == "Y"): ?><span
                                        class="bx-authform-starrequired">*</span><? endif ?><?= $arUserField["EDIT_FORM_LABEL"] ?>
                            </div>
                            <div class="bx-authform-input-container">
                                <?
